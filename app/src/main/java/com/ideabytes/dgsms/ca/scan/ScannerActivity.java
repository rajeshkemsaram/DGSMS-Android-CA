package com.ideabytes.dgsms.ca.scan;
 ...
 * author:  Suman
 * Description : This class is to scan bar code or QR code
 * Modified Date : 27-10-2015
 **********************************************************/
public class ScannerActivity extends Activity implements
Camera.PreviewCallback, DBConstants {
	/**
	 * @author Suman
	 * @since 2.0
	 */
	...
	public void setupScanner() {
		try {
			...
			new Exceptions(getApplicationContext(),ScannerActivity.this
	...
	public void onPreviewFrame(byte[] data, Camera camera) {
		...
		if (result != 0) {
			...
			for (Symbol sym : syms) {
				...
				//Log.i(TAG, "scan code result=="+symData);
	...
	public void onToggleClicked(View view) {
		try {
			...
			if (hasFlash) {
				...
				new Utils(ScannerActivity.this).showToastMessage(Utils.getResString(R.string.Toast_No_Fhash_Light));
